...
class Agent:
    ...
    def cutoff(self, state, depth):
        ...
        max_depth = 3
        if st<10: max_depth = 1
        elif time_left<(self.number_tower*2): max_depth = 1
        elif time_left<(self.number_tower*15): max_depth = 2
    ...
    def get_towers_neighbors(self, state, towers, max_dist):
        ...
        return towers1 + towers2 + towers0
